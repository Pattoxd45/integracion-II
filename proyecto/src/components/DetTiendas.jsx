    ...
    >
      ...
      >
        ...
        <div className="flex-1 p-4">
          <h2 className="text-lg sm:text-xl md:text-2xl text-[#3587cf] mb-4">{store.name}</h2>
          <p className="text-sm sm:text-base text-[#e2e7eb]">{store.description}</p>
          
          {!isOnlineStore && (
            <>
              <h3 className="text-sm sm:text-lg text-[#3587cf] mt-4">Dirección:</h3>
              <p className="text-xs sm:text-sm text-[#e2e7eb]">{store.direccion}</p>
              <h3 className="text-sm sm:text-lg text-[#3587cf] mt-4">Región:</h3>
              <p className="text-xs sm:text-sm text-[#e2e7eb]">{store.region}</p>
            </>
          )}
