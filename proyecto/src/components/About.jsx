      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-base sm:text-lg leading-relaxed text-center mb-8">
            ...
            . Nuestra misión es ofrecer una plataforma donde los jugadores
            puedan optimizar la creación de sus mazos utilizando las
            estadísticas de cada carta, para mejorar su experiencia de juego y
            tomar decisiones estratégicas informadas.
          </p>
          <p className="text-base sm:text-lg leading-relaxed text-center mb-8">
            Nuestro enfoque está en proporcionar información detallada y
            análisis de las cartas disponibles, con el objetivo de facilitar la
            elección de las mejores cartas para cada formato de juego.
          </p>
          <p className="text-base sm:text-lg leading-relaxed text-center mb-8">
            Nuestro objetivo es ayudarte a comprender mejor el potencial de cada
            carta y permitirte construir los mazos más competitivos, basándote
            en datos y estadísticas confiables.
          </p>
          <p className="text-base sm:text-lg leading-relaxed text-center mb-8">
            ¡Esperamos que encuentres esta página útil y que disfrutes del mundo
            de Magic como nunca antes!
          </p>
        </div>
      </div>

      <div className="max-w-[1200px] mx-auto mb-[20px] p-4 text-[#e2e7eb]">
        <h2 className="text-3xl font-bold text-[#3587cf] text-center mb-4">
          Formatos
        </h2>
        <p className="text-lg leading-relaxed text-center text-[#e2e7eb]">
          Magic: The Gathering ofrece varios formatos de juego, cada uno con
          reglas y características únicas. Algunos formatos permiten construir
          mazos con colecciones específicas, mientras que otros permiten
          estrategias con cartas de toda la historia de Magic.
        </p>
        <p className="text-lg leading-relaxed text-center text-[#e2e7eb]">
          <strong>Formatos Limitados:</strong> Se juegan con cartas de un pool
          restringido, construyendo mazos a partir de lo que se obtiene en
          boosters.
        </p>
        <p className="text-lg leading-relaxed text-center text-[#e2e7eb]">
          <strong>Formatos Constructed:</strong> Permiten la creación de mazos a
          partir de una colección más amplia, con listas de cartas prohibidas o
          restringidas.
        </p>
        <p className="text-lg leading-relaxed text-center text-[#e2e7eb]">
          <strong>Formatos Especiales:</strong> Incluyen variantes y reglas que
          pueden alterar significativamente la experiencia de juego.
        </p>
      </div>
