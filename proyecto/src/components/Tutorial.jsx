...
const TutorialCard = () => {
  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 space-y-6 mb-6 text-[#e2e7eb] flex flex-col items-center">
      <h1 className="text-3xl font-bold text-center mt-4">Tutorial</h1>
      {step === 0 && (
      ...
      {step === 3 && !showDeck && (
        <>
          ...
          <div className="flex flex-col lg:flex-row items-start justify-center">
            <div
              className={`relative bg-[#12171E] rounded-lg overflow-hidden shadow-xl w-full sm:w-[300px] lg:w-[350px] h-[450px] transition-transform ${
                shifted ? "lg:translate-x-[-20%]" : ""
              }`}
            >
              {loading ? (
                <div className="flex justify-center items-center w-full h-full">
              ...
              {deck.map((cardUrl, index) => (
                <div
                  ...
                  className={`cursor-pointer border ${
                    selectedCards.includes(cardUrl)
