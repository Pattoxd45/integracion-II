        ...
        <Slider {...settings}>
          {news.map((newsItem, index) => (
            <div key={index} className="p-4">
              <div className="flex flex-col md:flex-row bg-[#000] rounded-lg overflow-hidden shadow-xl h-auto">
                ...
                <div className="p-4 flex flex-col justify-center flex-grow">
                  ...
                  <a href={newsItem.link} target="_blank" rel="noopener noreferrer" className="text-[#E83411]">
                    ver más...
                  </a>
                </div>
              </div>
