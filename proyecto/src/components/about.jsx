...
const About = () => {
  ...
  return (
    <>
      <div 
        className="relative max-w-[1200px] mx-auto mb-[20px] p-4 sm:p-6 min-h-[40vh] h-auto rounded-lg shadow-xl text-white bg-cover bg-center"
        style={{ backgroundImage: `url(${fondo1})`, backgroundSize: 'cover' }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-50 rounded-lg"></div>
        <div className="relative z-10">
          <h1 className="text-3xl sm:text-4xl font-bold text-[#e85438] text-center mb-6 font-['ROBOTO']">SOBRE NOSOTROS</h1>
        ...
        <div className="flex flex-wrap justify-between">
          {tarjetas.slice(0, visibleCount).map((tarjeta, index) => (
            ...
            >
              ...
              <div className="absolute -top-4 left-4 bg-black bg-opacity-70 text-white text-xs font-bold px-2 py-1 rounded z-20">
